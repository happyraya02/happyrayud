                    ...
                    <div class="card-body">
                        <form action="{{route('transaksi.update', $transaksi->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="nama" id="" value="{{$transaksi->nama}}"disabled>
                            </div>
                           <div class="form-group">
                                <label for="">nama Kopi</label>
                                <input class="form-control" type="text" name="nama_coffee" id="" value="{{$transaksi->coffee->nama_kopi}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">jumlah_kopi</label>
                                <input class="form-control" type="text" name="jumlah_kopi" id="" value="{{$transaksi->jumlah_kopi}}"disabled>
                            </div>
                            <div class="form-group">
                                <a href="{{url('transaksi')}}" class="btn btn-outline-info">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
