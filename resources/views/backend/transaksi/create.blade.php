                    ...
                    <div class="card-body">
                        <form action="{{route('transaksi.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control{{$errors->has('coffee') ? 'has-error' : '' }}" type="text"
                                    name="id_coffee" id="s2_demo3" required>
                                @foreach ($coffee as $data)
                                    <option value="{{$data->id}}">
                                    {{$data->nama_kopi}}</option>
                                @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="jumlah_kopi" id="">
                            </div>
                            <div class="form-group">
