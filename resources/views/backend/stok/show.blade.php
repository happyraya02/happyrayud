                    ...
                    <div class="card-body">
                        <form action="{{route('stok.update', $stok->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="nama_kopi" id="" value="{{$stok->nama_kopi}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">jumlah_barang</label>
                                <input class="form-control" type="text" name="jumlah_barang" id="" value="{{$stok->jumlah_barang}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">barang_masuk</label>
                                <input class="form-control" type="text" name="barang_masuk" id="" value="{{$stok->barang_masuk}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">barang_keluar</label>
                                <input class="form-control" type="text" name="barang_keluar" id="" value="{{$stok->barang_keluar}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">sisa_barang</label>
                                <input class="form-control" type="text" name="sisa_barang" id="" value="{{$stok->sisa_barang}}"disabled>
                            </div>
                            <div class="form-group">
                                <a href="{{url('stok')}}" class="btn btn-outline-info">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
